        ...
        <div>
          ...
          <div className="py-8 px-5">
            <ul className="grid gap-2">
              <li
                className={`flex items-center gap-2 border p-3 rounded-lg text-lg hover:bg-blue-400 hover:text-white ${
                  active === "overview" && "bg-blue-400 text-white"
                }`}
              ...
              <li
                className={`flex items-center gap-2 border p-3 rounded-lg text-lg hover:bg-blue-400 hover:text-white ${
                  active === "bookings" && "bg-blue-400 text-white"
                }`}
              ...
              <li
                className={`flex items-center gap-2 border p-3 rounded-lg text-lg hover:bg-blue-400 hover:text-white ${
                  active === "support" && "bg-blue-400 text-white"
                }`}
              ...
              <li
                className={`flex items-center gap-2 border p-3 rounded-lg text-lg hover:bg-blue-400 hover:text-white ${
                  active === "feedback" && "bg-blue-400 text-white"
                }`}
