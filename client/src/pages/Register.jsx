        ...
        <div className="min-h-screen w-200 flex items-center justify-center font-serif mt-70">
          <div className="bg-white/10 backdrop-blur-xl p-10 rounded-2xl shadow-2xl w-full max-w-md border border-yellow-500">
            ...
            <form className="space-y-5" onSubmit={handelSubmit}>
              <div>
                <label className="text-black-500 block mb-1">Name</label>
                <input
                  type="text"
                  name="fullName"
              ...
              <div>
                <label className="text-black-500 block mb-1">Email</label>
                <input
                  type="email"
                  name="email"
                  className="w-full px-4 py-2 rounded-lg bg-white/20 text-black placeholder:text-gray-500 border border-yellow-400 focus:outline-none focus:ring-2 focus:ring-pink-300"
              ...
              <div>
                <label className="text-black-500 block mb-1">Phone Number</label>
                <input
                  type="tel"
                  name="phone"
                  className="w-full px-4 py-2 rounded-lg bg-white/20 text-black placeholder:text-gray-500 border border-yellow-400 focus:outline-none focus:ring-2 focus:ring-pink-300"
              ...
              <div>
                <label className="text-black-500 block mb-1">Password</label>
                <input
                  type="password"
                  name="password"
                  className="w-full px-4 py-2 rounded-lg bg-white/20 text-black placeholder:text-gray-500 border border-yellow-400 focus:outline-none focus:ring-2 focus:ring-pink-300"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-black-500 to-black-600 text-[#0f172a] font-semibold py-2 rounded-xl shadow-lg hover:scale-105 transition-transform duration-200"
              >
                Register
              </button>
            </form>
            <p className="text-center text-sm text-black mt-6">
              ...
              <span
                className="text-black-400 underline cursor-pointer"
